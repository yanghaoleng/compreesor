...
export type Messages = {
  ...
  packageWhich: string
  packageWhichHint: string
  packageOneQuality: string
  packageAllQualities: string
  dragMore: string
  donateTitle: string
  donateIntro: string
...
export const I18N: Record<Locale, Messages> = {
  zh: {
    brandSubtitle: '文件压缩大救星', outputPreferences: '输出偏好', compressionLevel: '压缩比例', extreme: '极限', balanced: '够用', lossless: '无损', allQualities: '我都要',
    target100k: '≤ 100 KB（证照图片 / 报名头像）', target500k: '≤ 500 KB（证件扫描 / 表单附件）', target2m: '≤ 2 MB（报名材料 / 简历附件）', target5m: '≤ 5 MB（办事材料 / 合同附件）', target10m: '≤ 10 MB（PDF 文档 / 长材料）', image: '图片', video: '视频',
    ...
    failed: '处理失败', retry: '重试', download: '下载', reveal: '在文件夹中显示', preview: '预览', closePreview: '关闭预览', previousPreview: '上一个', nextPreview: '下一个',
    unsupported: '请选择 JPG、PNG、WebP、AVIF、JXL、SVG、GIF、PDF 或视频文件',
    tooLarge: '图片和 PDF 需小于 100 MB，GIF 或视频需小于 500 MB', ignored: '已忽略不支持的文件',
    maxFiles: '一次最多处理 30 个文件', packageFailed: '打包失败，请先单个下载完成的文件', packageWhich: '打包哪种质量？', packageWhichHint: '选择统一质量，或把三种结果全部打包。', packageOneQuality: '每个文件一份', packageAllQualities: '每个文件三份',
    ...
    guideFormatTitle: '先选择输出格式', guideFormatText: '“我都要”会同时生成极限、够用、无损三档；也可按常见平台体积限制自动调整画质、尺寸与码率。PDF 无损档尽量保留原结构，其他档位按页优化。',
  ...
  'zh-Hant': {
    brandSubtitle: '檔案壓縮大救星', outputPreferences: '輸出偏好', compressionLevel: '壓縮比例', extreme: '極限', balanced: '夠用', lossless: '無損', allQualities: '我都要',
    target100k: '≤ 100 KB（證照圖片 / 報名頭像）', target500k: '≤ 500 KB（證件掃描 / 表單附件）', target2m: '≤ 2 MB（報名資料 / 履歷附件）', target5m: '≤ 5 MB（辦事資料 / 合約附件）', target10m: '≤ 10 MB（PDF 文件 / 長篇資料）', image: '圖片', video: '影片',
    ...
    failed: '處理失敗', retry: '重試', download: '下載', reveal: '在資料夾中顯示', preview: '預覽', closePreview: '關閉預覽', previousPreview: '上一個', nextPreview: '下一個',
    unsupported: '請選擇 JPG、PNG、WebP、AVIF、JXL、SVG、GIF、PDF 或影片檔案',
    tooLarge: '圖片與 PDF 需小於 100 MB，GIF 或影片需小於 500 MB', ignored: '已略過不支援的檔案',
    maxFiles: '一次最多處理 30 個檔案', packageFailed: '打包失敗，請先單獨下載完成的檔案', packageWhich: '要打包哪種品質？', packageWhichHint: '選擇統一品質，或將三種結果全部打包。', packageOneQuality: '每個檔案一份', packageAllQualities: '每個檔案三份',
    ...
    guideFormatTitle: '先選擇輸出格式', guideFormatText: '「我都要」會同時產生極限、夠用、無損三種結果；也可依常見平台體積限制自動調整畫質、尺寸與碼率。PDF 無損檔盡量保留原結構，其他檔位會逐頁最佳化。',
  ...
  en: {
    brandSubtitle: 'File Compression Lifesaver', outputPreferences: 'Output preferences', compressionLevel: 'Compression', extreme: 'Extreme', balanced: 'Balanced', lossless: 'Lossless', allQualities: 'I want all three',
    target100k: '≤ 100 KB (ID photos / profile photos)', target500k: '≤ 500 KB (ID scans / form files)', target2m: '≤ 2 MB (applications / résumés)', target5m: '≤ 5 MB (service files / contracts)', target10m: '≤ 10 MB (PDFs / long documents)', image: 'Images', video: 'Video',
    ...
    failed: 'Failed', retry: 'Retry', download: 'Download', reveal: 'Show in folder', preview: 'Preview', closePreview: 'Close preview', previousPreview: 'Previous', nextPreview: 'Next',
    ...
    maxFiles: 'Up to 30 files can be processed at once', packageFailed: 'ZIP creation failed. Download completed files individually.', packageWhich: 'Which quality should be zipped?', packageWhichHint: 'Choose one consistent quality or include all three results.', packageOneQuality: 'One per file', packageAllQualities: 'Three per file',
    ...
    guideFormatTitle: 'Choose output formats', guideFormatText: '“I want all three” creates Extreme, Balanced and Lossless results together. Size targets automatically tune quality, dimensions and bitrates. Lossless PDF aims to preserve its structure; other modes optimize page images.',
  ...
  ja: {
    brandSubtitle: 'ファイル圧縮の救世主', outputPreferences: '出力設定', compressionLevel: '圧縮率', extreme: '極限', balanced: '標準', lossless: 'ロスレス', allQualities: '3種類すべて',
    target100k: '≤ 100 KB（証明写真 / 登録写真）', target500k: '≤ 500 KB（身分証スキャン / フォーム添付）', target2m: '≤ 2 MB（応募書類 / 履歴書）', target5m: '≤ 5 MB（申請資料 / 契約書）', target10m: '≤ 10 MB（PDF / 長い資料）', image: '画像', video: '動画',
    ...
    failed: '処理失敗', retry: '再試行', download: 'ダウンロード', reveal: 'フォルダーに表示', preview: 'プレビュー', closePreview: '閉じる', previousPreview: '前へ', nextPreview: '次へ',
    ...
    maxFiles: '一度に最大 30 ファイルまで処理できます', packageFailed: 'ZIP 作成に失敗しました。完了したファイルを個別に保存してください。', packageWhich: 'どの品質をまとめますか？', packageWhichHint: '1つの品質、または3種類すべてを選べます。', packageOneQuality: '各ファイル1つ', packageAllQualities: '各ファイル3つ',
    ...
    guideFormatTitle: '出力形式を選択', guideFormatText: '「3種類すべて」は極限・標準・ロスレスを同時に生成します。容量目標では画質、寸法、ビットレートを自動調整します。PDF のロスレスは構造保持を優先し、その他はページ画像を最適化します。',
