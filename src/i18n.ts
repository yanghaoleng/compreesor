...
export const I18N: Record<Locale, Messages> = {
  zh: {
    brandSubtitle: '文件压缩', outputPreferences: '输出偏好', compressionLevel: '压缩比例', extreme: '极限', balanced: '够用', lossless: '无损', image: '图片', video: '视频',
    ...
    guideFormatTitle: '先选择输出格式', guideFormatText: '图片可压缩为原格式或转为 JPG、WebP、PNG。视频可转为 MP4、MOV、透明 MOV，也可提取 MP3；压缩比例默认是够用。',
    ...
    homeLabel: 'Compreesor 首页', progressLabel: (fileName) => `${fileName} 的处理进度`,
  },
  'zh-Hant': {
    brandSubtitle: '檔案壓縮', outputPreferences: '輸出偏好', compressionLevel: '壓縮比例', extreme: '極限', balanced: '夠用', lossless: '無損', image: '圖片', video: '影片',
    ...
    guideFormatTitle: '先選擇輸出格式', guideFormatText: '圖片可壓縮為原格式或轉為 JPG、WebP、PNG。影片可轉為 MP4、MOV、透明 MOV，也可提取 MP3；壓縮比例預設為夠用。',
    ...
    homeLabel: 'Compreesor 首頁', progressLabel: (fileName) => `${fileName} 的處理進度`,
  },
  en: {
    brandSubtitle: 'File compressor', outputPreferences: 'Output preferences', compressionLevel: 'Compression', extreme: 'Extreme', balanced: 'Balanced', lossless: 'Lossless', image: 'Images', video: 'Video',
    ...
    guideFormatTitle: 'Choose output formats', guideFormatText: 'Compress images in their original format or convert to JPG, WebP or PNG. Convert video to MP4, MOV, transparent MOV, or extract MP3. Compression defaults to Balanced.',
    ...
    homeLabel: 'Compreesor home', progressLabel: (fileName) => `Processing progress for ${fileName}`,
  },
  ja: {
    brandSubtitle: 'ファイル圧縮', outputPreferences: '出力設定', compressionLevel: '圧縮率', extreme: '極限', balanced: '標準', lossless: 'ロスレス', image: '画像', video: '動画',
    ...
    guideFormatTitle: '出力形式を選択', guideFormatText: '画像は元の形式で圧縮するか JPG、WebP、PNG に変換できます。動画は MP4、MOV、透過 MOV、MP3 抽出に対応し、圧縮率の既定値は標準です。',
    ...
    homeLabel: 'Compreesor ホーム', progressLabel: (fileName) => `${fileName} の処理進捗`,
  },
}
